// ignore_for_file: prefer_is_not_operator, annotate_overrides, prefer_final_fields, constant_identifier_names, camel_case_types, non_constant_identifier_names

class Input$ContinentFilterInput {
  factory Input$ContinentFilterInput({Input$StringQueryOperatorInput? code}) => Input$ContinentFilterInput._({
  ...
  factory Input$ContinentFilterInput.fromJson(Map<String, dynamic> data) {
    ...
    if (data.containsKey('code')) {
      ...
      result$data['code'] = l$code == null ? null : Input$StringQueryOperatorInput.fromJson((l$code as Map<String, dynamic>));
    }
  ...
  Input$StringQueryOperatorInput? get code => (_$data['code'] as Input$StringQueryOperatorInput?);
  ...
  CopyWith$Input$ContinentFilterInput<Input$ContinentFilterInput> get copyWith => CopyWith$Input$ContinentFilterInput(
        this,
        (i) => i,
      );
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Input$ContinentFilterInput) || runtimeType != other.runtimeType) {
      return false;
    }
    final l$code = code;
...
abstract class CopyWith$Input$ContinentFilterInput<TRes> {
  ...
  factory CopyWith$Input$ContinentFilterInput.stub(TRes res) = _CopyWithStubImpl$Input$ContinentFilterInput;

  TRes call({Input$StringQueryOperatorInput? code});
  CopyWith$Input$StringQueryOperatorInput<TRes> get code;
}

class _CopyWithImpl$Input$ContinentFilterInput<TRes> implements CopyWith$Input$ContinentFilterInput<TRes> {
  _CopyWithImpl$Input$ContinentFilterInput(
    this._instance,
    this._then,
  );
  ...
  TRes call({Object? code = _undefined}) => _then(Input$ContinentFilterInput._({
        ..._instance._$data,
        if (code != _undefined) 'code': (code as Input$StringQueryOperatorInput?),
      }));
  ...
  CopyWith$Input$StringQueryOperatorInput<TRes> get code {
    ...
    return local$code == null
        ...
        : CopyWith$Input$StringQueryOperatorInput(local$code, (e) => call(code: e));
  }
}

class _CopyWithStubImpl$Input$ContinentFilterInput<TRes> implements CopyWith$Input$ContinentFilterInput<TRes> {
  ...
  CopyWith$Input$StringQueryOperatorInput<TRes> get code => CopyWith$Input$StringQueryOperatorInput.stub(_res);
}
...
class Input$CountryFilterInput {
  ...
  factory Input$CountryFilterInput.fromJson(Map<String, dynamic> data) {
    ...
    if (data.containsKey('continent')) {
      ...
      result$data['continent'] = l$continent == null ? null : Input$StringQueryOperatorInput.fromJson((l$continent as Map<String, dynamic>));
    }
    if (data.containsKey('currency')) {
      final l$currency = data['currency'];
      result$data['currency'] = l$currency == null ? null : Input$StringQueryOperatorInput.fromJson((l$currency as Map<String, dynamic>));
    }
    if (data.containsKey('name')) {
      final l$name = data['name'];
      result$data['name'] = l$name == null ? null : Input$StringQueryOperatorInput.fromJson((l$name as Map<String, dynamic>));
    }
  ...
  Input$StringQueryOperatorInput? get continent => (_$data['continent'] as Input$StringQueryOperatorInput?);

  Input$StringQueryOperatorInput? get currency => (_$data['currency'] as Input$StringQueryOperatorInput?);

  Input$StringQueryOperatorInput? get name => (_$data['name'] as Input$StringQueryOperatorInput?);
  ...
  CopyWith$Input$CountryFilterInput<Input$CountryFilterInput> get copyWith => CopyWith$Input$CountryFilterInput(
        this,
        (i) => i,
      );
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Input$CountryFilterInput) || runtimeType != other.runtimeType) {
      return false;
    }
    final l$code = code;
    final lOther$code = other.code;
    ...
    if (_$data.containsKey('continent') != other._$data.containsKey('continent')) {
      return false;
    }
    ...
    if (_$data.containsKey('currency') != other._$data.containsKey('currency')) {
      return false;
    }
...
abstract class CopyWith$Input$CountryFilterInput<TRes> {
  ...
  factory CopyWith$Input$CountryFilterInput.stub(TRes res) = _CopyWithStubImpl$Input$CountryFilterInput;
...
class _CopyWithImpl$Input$CountryFilterInput<TRes> implements CopyWith$Input$CountryFilterInput<TRes> {
  _CopyWithImpl$Input$CountryFilterInput(
    this._instance,
    this._then,
  );
  ...
  TRes call({
    ...
    Object? name = _undefined,
      ...
      _then(Input$CountryFilterInput._({
        ..._instance._$data,
        if (code != _undefined) 'code': (code as Input$StringQueryOperatorInput?),
        if (continent != _undefined) 'continent': (continent as Input$StringQueryOperatorInput?),
        if (currency != _undefined) 'currency': (currency as Input$StringQueryOperatorInput?),
        if (name != _undefined) 'name': (name as Input$StringQueryOperatorInput?),
      }));
  ...
  CopyWith$Input$StringQueryOperatorInput<TRes> get continent {
    ...
    return local$continent == null
        ? CopyWith$Input$StringQueryOperatorInput.stub(_then(_instance))
        : CopyWith$Input$StringQueryOperatorInput(local$continent, (e) => call(continent: e));
  }
  ...
  CopyWith$Input$StringQueryOperatorInput<TRes> get currency {
    ...
    return local$currency == null
        ? CopyWith$Input$StringQueryOperatorInput.stub(_then(_instance))
        : CopyWith$Input$StringQueryOperatorInput(local$currency, (e) => call(currency: e));
  }
  ...
  CopyWith$Input$StringQueryOperatorInput<TRes> get name {
    ...
    return local$name == null
        ? CopyWith$Input$StringQueryOperatorInput.stub(_then(_instance))
        : CopyWith$Input$StringQueryOperatorInput(local$name, (e) => call(name: e));
  }
}

class _CopyWithStubImpl$Input$CountryFilterInput<TRes> implements CopyWith$Input$CountryFilterInput<TRes> {
  ...
  CopyWith$Input$StringQueryOperatorInput<TRes> get continent => CopyWith$Input$StringQueryOperatorInput.stub(_res);

  CopyWith$Input$StringQueryOperatorInput<TRes> get currency => CopyWith$Input$StringQueryOperatorInput.stub(_res);

  CopyWith$Input$StringQueryOperatorInput<TRes> get name => CopyWith$Input$StringQueryOperatorInput.stub(_res);
}

class Input$LanguageFilterInput {
  factory Input$LanguageFilterInput({Input$StringQueryOperatorInput? code}) => Input$LanguageFilterInput._({
        if (code != null) r'code': code,
      });
  ...
  CopyWith$Input$LanguageFilterInput<Input$LanguageFilterInput> get copyWith => CopyWith$Input$LanguageFilterInput(
        this,
        (i) => i,
      );
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Input$LanguageFilterInput) || runtimeType != other.runtimeType) {
      return false;
    }
    final l$code = code;
    final lOther$code = other.code;
...
abstract class CopyWith$Input$LanguageFilterInput<TRes> {
  ...
  factory CopyWith$Input$LanguageFilterInput.stub(TRes res) = _CopyWithStubImpl$Input$LanguageFilterInput;

  TRes call({Input$StringQueryOperatorInput? code});
  CopyWith$Input$StringQueryOperatorInput<TRes> get code;
}

class _CopyWithImpl$Input$LanguageFilterInput<TRes> implements CopyWith$Input$LanguageFilterInput<TRes> {
  _CopyWithImpl$Input$LanguageFilterInput(
    this._instance,
    this._then,
  );
...
class _CopyWithStubImpl$Input$LanguageFilterInput<TRes> implements CopyWith$Input$LanguageFilterInput<TRes> {
...
class Input$StringQueryOperatorInput {
  ...
  factory Input$StringQueryOperatorInput.fromJson(Map<String, dynamic> data) {
    ...
    if (data.containsKey('in')) {
      final l$$in = data['in'];
      result$data['in'] = (l$$in as List<dynamic>?)?.map((e) => (e as String)).toList();
    }
    ...
    if (data.containsKey('nin')) {
      ...
      result$data['nin'] = (l$nin as List<dynamic>?)?.map((e) => (e as String)).toList();
    }
  ...
  CopyWith$Input$StringQueryOperatorInput<Input$StringQueryOperatorInput> get copyWith => CopyWith$Input$StringQueryOperatorInput(
        this,
        (i) => i,
      );
  ...
  bool operator ==(Object other) {
    ...
    if (!(other is Input$StringQueryOperatorInput) || runtimeType != other.runtimeType) {
      return false;
    }
    final l$eq = eq;
...
abstract class CopyWith$Input$StringQueryOperatorInput<TRes> {
  ...
  factory CopyWith$Input$StringQueryOperatorInput.stub(TRes res) = _CopyWithStubImpl$Input$StringQueryOperatorInput;
...
class _CopyWithImpl$Input$StringQueryOperatorInput<TRes> implements CopyWith$Input$StringQueryOperatorInput<TRes> {
  _CopyWithImpl$Input$StringQueryOperatorInput(
    this._instance,
    this._then,
  );
...
class _CopyWithStubImpl$Input$StringQueryOperatorInput<TRes> implements CopyWith$Input$StringQueryOperatorInput<TRes> {
...
enum Enum$__TypeKind { SCALAR, OBJECT, INTERFACE, UNION, ENUM, INPUT_OBJECT, LIST, NON_NULL, $unknown }
